...
**Next:** `/vs-rfc-research` (formalize findings into a proposal) | `/vs-grill-me` (stress-test a design found during research) | `/vs-autopilot` (implement based on findings)
