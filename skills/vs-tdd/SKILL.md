...
**Prev:** `/vs-debug-mode` (found root cause, need a regression test) | `/vs-autopilot` (uses TDD internally)
**Next:** `/vs-roast-my-code` (review the implementation) | `/vs-ship-it` (ship it)
